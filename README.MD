...
The ViewController in the sample, contains a fully worked out Beacon Sighting Event using sample data. It also shows a how to send data to DataSnap using a generic event function.
